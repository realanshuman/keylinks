...
function Dashboard() {
  ...
  async function toggleDisabled(l: LinkRow) {
    ...
    await supabase
      .from("activity_logs")
      .insert({ action: l.disabled ? "enabled" : "disabled", link_id: l.id });
  ...
  function copyLink(l: LinkRow) {
    navigator.clipboard.writeText(`${window.location.origin}/r/${l.slug}`);
  ...
  const adminBadge = (
    <span className="rounded-md bg-accent px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wider text-accent-foreground">
      Admin
    </span>
  );
                  ...
                  {filtered.map((l) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="max-w-[160px] truncate px-3 py-2.5 font-mono text-xs">
                          {l.code}
                        </td>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="truncate text-sm font-medium">
                      {l.label ?? (
                        <span className="font-normal text-muted-foreground">No label</span>
                      )}
                    </div>
                    ...
                    <div className="mt-3 grid grid-cols-4 gap-2 border-t border-border/60 pt-3">
                      ...
                      <MobileAction label="Open" href={`/r/${l.slug}`}>
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center gap-2 px-3 py-12 text-center">
      ...
      <p className="text-sm text-muted-foreground">No links match.</p>
    </div>
  );
}
